...
const LuckyWordSearch2025 = () => {
  ...
  // 20 positive luck-related words
  const words = [
    { word: 'LUCKY', meaning: '🍀 Good Fortune' },
    { word: 'BLESSED', meaning: '🙏 Divine Favor' },
    { word: 'FORTUNE', meaning: '💰 Wealth & Success' },
    { word: 'SUCCESS', meaning: '🎯 Achievement' },
    { word: 'PROSPERITY', meaning: '📈 Abundance' },
    { word: 'WEALTH', meaning: '💎 Riches' },
    { word: 'HAPPY', meaning: '😊 Joy' },
    { word: 'JOY', meaning: '✨ Delight' },
    { word: 'VICTORY', meaning: '🏆 Triumph' },
    { word: 'ACHIEVE', meaning: '⭐ Accomplish' },
    { word: 'ABUNDANCE', meaning: '🌟 Plenty' },
    { word: 'MIRACLE', meaning: '🎁 Wonder' },
    { word: 'DREAM', meaning: '💫 Aspiration' },
    { word: 'HEALTH', meaning: '💪 Wellness' },
    { word: 'PEACE', meaning: '🕊️ Harmony' },
    { word: 'LOVE', meaning: '❤️ Affection' },
    { word: 'HOPE', meaning: '🌈 Optimism' },
    { word: 'FAITH', meaning: '✝️ Belief' },
    { word: 'GRACE', meaning: '👼 Elegance' },
    { word: 'THRIVE', meaning: '🌱 Flourish' }
  ];
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="inline-block bg-white rounded-3xl px-4 md:px-8 py-4 md:py-6 shadow-2xl transform -rotate-1 hover:rotate-0 transition-transform">
            ...
            <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 rounded-2xl px-4 md:px-6 py-2 md:py-3 transform rotate-1 hover:rotate-0 transition-transform">
              <p className="text-lg md:text-2xl font-bold text-white">
                First 3 Words Predict Your 2025! 🔮
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur rounded-2xl p-3 md:p-4 mb-3 md:mb-4 shadow-lg">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm md:text-base font-bold text-purple-600">{foundWords.length}/20</span>
          </div>
        ...
        <div className="bg-white/90 backdrop-blur rounded-2xl p-3 md:p-4 mb-3 md:mb-4 shadow-lg">
          <p className="text-center text-gray-700 font-medium text-sm md:text-base">
            🎯 Drag mouse through letters to find words • Your first 3 words are your 2025 fortune!
          </p>
        </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/95 backdrop-blur rounded-2xl p-4 md:p-6 shadow-lg sticky top-4">
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {[...words].sort((a, b) => a.word.localeCompare(b.word)).map(({ word, meaning }) => (
                  <div
                    key={word}
                    className={`
                  ...
                  >
                    ...
                    {foundWords.includes(word) && (
                      <div className="text-xs mt-1 opacity-90">{meaning}</div>
                    )}
                  </div>
                ))}
              </div>
        ...
        {/* Prediction Result */}
        {foundWords.length >= 3 && (
          <div className="mt-6 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 rounded-3xl p-6 md:p-8 shadow-2xl animate-pulse">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 text-center flex items-center justify-center gap-2">
              <span className="text-3xl md:text-4xl">🔮</span>
              Your 2025 Fortune!
              <span className="text-3xl md:text-4xl">🔮</span>
            </h2>
            <div className="bg-white/20 backdrop-blur rounded-2xl p-4 md:p-6">
              <p className="text-white text-center text-lg md:text-xl font-bold leading-relaxed">
                {foundWords.slice(0, 3).map((w, i) => {
                  const wordObj = words.find(x => x.word === w);
                  return (
              ...
              <p className="text-white/90 text-center text-sm md:text-base mt-4 italic">
                "{foundWords.slice(0, 3).join(', ')}"
              </p>
            </div>
          </div>
        )}
        ...
        {foundWords.length === 20 && (
          <div className="mt-6 bg-gradient-to-r from-yellow-400 via-orange-400 to-red-500 rounded-3xl p-6 md:p-8 shadow-2xl text-center animate-bounce">
            <p className="text-3xl md:text-5xl mb-4">🎉🏆🎊</p>
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-2">
              AMAZING! You Found All Words!
            </h2>
            <p className="text-lg md:text-xl text-white/90">
              2025 will be absolutely incredible for you! ✨
            </p>
          </div>
        )}
        ...
        <div className="flex flex-col md:flex-row gap-3 justify-center mt-6">
          <button
            ...
            className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-base md:text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
